/* Compile command: g++ -o HashTable.exe -std=c++11 -static-libgcc -static-libstdc++ HashTable.cpp */
#include <iostream>
#include <math.h>
#include "HashTable.h"
...
int main() {
    ...
    hashTable.insert("two", "1+1");

    cout << "HashTable size is " << hashTable.size << endl;
    cout << "one is " << hashTable.lookup("one") << endl;
    cout << "two is " << hashTable.lookup("two") << endl;
